if (typeof(JS_LIB_LOADED)=='boolean') 
{
  ...
  var JS_ZIP_LOADED       = true;
  var JS_ZIP_FILE         = "zip.js";

  var JS_ZIP_CID          = "@mozilla.org/libjar/zip-reader;1";
  var JS_ZIP_I_ZIP_READER = "nsIZipReader";

  // DEPRECATED! MARKED FOR REMOVAL
  var JS_ZIP_FILE_CID     = "@mozilla.org/file/local;1";
  var JS_ZIP_I_LOCAL_FILE = "nsILocalFile";
  var JS_ZIP_FILE_INIT    = "initWithPath";
