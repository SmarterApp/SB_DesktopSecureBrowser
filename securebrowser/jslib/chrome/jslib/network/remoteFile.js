...
{
  var JS_REMOTEFILE_FILE     = "remoteFile.js";
  var JS_REMOTEFILE_LOADED   = true;
  
  var JS_REMOTEFILE_URI_CID  = "@mozilla.org/network/simple-uri;1";
  var JS_REMOTEFILE_URI_I_ID = jslibI.nsIURI;
  
  var JS_REMOTEFILE_IOSERVICE_CID  = "@mozilla.org/network/io-service;1";
  var JS_REMOTEFILE_I_IOSERVICE    = jslibI.nsIIOService;
  var JS_REMOTEFILE_IOSERVICE      = jslibGetService(JS_REMOTEFILE_IOSERVICE_CID,
                                                       "nsIIOService");
