...
{
  var JS_SOCKET_FILE     = "socket.js";
  var JS_SOCKET_LOADED   = true;
  ...
  */
  Socket.prototype.init = function ()
  {
    ...
    if (!socketServiceClass)
      throw ("Socket varructor: Couldn't get socket service class.");
    
    var socketService = socketServiceClass.getService();

    if (!socketService)
        throw ("Socket varructor: Couldn't get socket service.");
