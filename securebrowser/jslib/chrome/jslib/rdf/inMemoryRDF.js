...
{
  var JS_INMEMORYRDF_LOADED = true;
  var JS_INMEMORYRDF_FILE   = "inMemoryRDF.js";
  var JSLIB_INMEM_CONTAINER_PROGID = '@mozilla.org/rdf/container;1';
  var JSLIB_INMEM_CONTAINER_UTILS_PROGID = '@mozilla.org/rdf/container-utils;1';
  var JSLIB_INMEM_RDF_PROGID = '@mozilla.org/rdf/rdf-service;1';
  var JSLIB_INMEM_RDF_MEM_PROGID = '@mozilla.org/rdf/datasource;1?name=in-memory-datasource';
  
  var JSLIB_INMEM_TYPE_BAG = 1;
  var JSLIB_INMEM_TYPE_ALT = 2;
  var JSLIB_INMEM_TYPE_SEQ = 3;
  var JSLIB_INMEM_TYPE_NODE = 4;
