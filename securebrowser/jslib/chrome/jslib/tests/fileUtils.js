...
var CHROME_JAR_URL   = "chrome://navigator/content/";
var CHROME_URL       = "chrome://jslib/content/";
var LOCAL_WIN_PATH   = "C:\\Program Files\\";
var LEAF             = "foo.dat";
var CHROME_BOGUS_URL = "chrome://bogus/content/";
...
// test for Linux
if (fu.exists("/tmp")) {
  var LOCAL_URL      = "file:///usr/local/";
  var LOCAL_PATH     = "/usr/src/";
...
if (fu.exists("C:\\WINDOWS")) {
  var LOCAL_WIN_URL      = "file:///C:/windows/system";
