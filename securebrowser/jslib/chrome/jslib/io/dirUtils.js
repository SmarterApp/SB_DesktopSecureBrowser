...
{
  var JS_DIRUTILS_FILE         = "dirUtils.js";
  var JS_DIRUTILS_LOADED       = true;
  
  var JS_DIRUTILS_FILE_DIR_CID = "@mozilla.org/file/directory_service;1";
  
  var JS_DIRUTILS_I_PROPS      = "nsIProperties";
  var JS_DIRUTILS_NSIFILE      = jslibI.nsIFile;
  
  /** 
   * /root/.mozilla/Default User/k1m30xaf.slt
   */
  var NS_APP_PREFS_50_DIR                  = "PrefD"; 
  
  /**
   * /usr/src/mozilla/dist/bin/chrome
   */
  var NS_APP_CHROME_DIR                    = "AChrom"; 
  
  /**
   * /root/.mozilla
   */
  var NS_APP_USER_PROFILES_ROOT_DIR        = "DefProfRt";  
  
  /**
   * /root/.mozilla/Default User/k1m30xaf.slt
   */
  var NS_APP_USER_PROFILE_50_DIR           = "ProfD";      
  
  /**
   * /root/.mozilla
   */
  var NS_APP_APPLICATION_REGISTRY_DIR      = "AppRegD"; 
  
  /** 
   * /root/.mozilla/appreg
   */
  var NS_APP_APPLICATION_REGISTRY_FILE     = "AppRegF"; 
  
  /** 
   * /usr/src/mozilla/dist/bin/defaults 
   */
  var NS_APP_DEFAULTS_50_DIR               = "DefRt";   
  
  /**
   * /usr/src/mozilla/dist/bin/defaults/pref
   */
  var NS_APP_PREF_DEFAULTS_50_DIR          = "PrfDef";  
  
  /**
   * /usr/src/mozilla/dist/bin/defaults/profile/US
   */
  var NS_APP_PROFILE_DEFAULTS_50_DIR       = "profDef"; 
  
  /** 
   * /usr/src/mozilla/dist/bin/defaults/profile 
   */
  var NS_APP_PROFILE_DEFAULTS_NLOC_50_DIR  = "ProfDefNoLoc"; 
  
  /** 
   * /usr/src/mozilla/dist/bin/res
   */
  var NS_APP_RES_DIR                       = "ARes"; 
  
  /** 
   * /usr/src/mozilla/dist/bin/plugins
   */
  var NS_APP_PLUGINS_DIR                   = "APlugns"; 
  
  /** 
   * /usr/src/mozilla/dist/bin/searchplugins
   */
  var NS_APP_SEARCH_DIR                    = "SrchPlugns"; 
  
  /**
   * /root/.mozilla/Default User/k1m30xaf.slt/prefs.js
   */
  var NS_APP_PREFS_50_FILE                 = "PrefF"; 
  
  /** 
   * /root/.mozilla/Default User/k1m30xaf.slt/chrome
   */
  var NS_APP_USER_CHROME_DIR               = "UChrm"; 
  
  /** 
   * /root/.mozilla/Default User/k1m30xaf.slt/localstore.rdf
   */
  var NS_APP_LOCALSTORE_50_FILE            = "LclSt"; 
  
  /** 
   * /root/.mozilla/Default User/k1m30xaf.slt/history.dat
   */
  var NS_APP_HISTORY_50_FILE               = "UHist"; 
  
  /** 
   * /root/.mozilla/Default User/k1m30xaf.slt/panels.rdf
   */
  var NS_APP_USER_PANELS_50_FILE           = "UPnls"; 
  
  /** 
   * /root/.mozilla/Default User/k1m30xaf.slt/mimeTypes.rdf
   */
  var NS_APP_USER_MIMETYPES_50_FILE        = "UMimTyp"; 
  
  /** 
   * /root/.mozilla/Default User/k1m30xaf.slt/bookmarks.html 
   */
  var NS_APP_BOOKMARKS_50_FILE             = "BMarks"; 
  
  /** 
   * /root/.mozilla/Default User/k1m30xaf.slt/search.rdf
   */
  var NS_APP_SEARCH_50_FILE                = "SrchF"; 
  
  /**
   * /root/.mozilla/Default User/k1m30xaf.slt/Mail
   */
  var NS_APP_MAIL_50_DIR                   = "MailD"; 
  
  /**
   * /root/.mozilla/Default User/k1m30xaf.slt/ImapMail
   */
  var NS_APP_IMAP_MAIL_50_DIR              = "IMapMD"; 
  
  /**
   * /root/.mozilla/Default User/k1m30xaf.slt/News
   */
  var NS_APP_NEWS_50_DIR                   = "NewsD"; 
  
  /** 
   * /root/.mozilla/Default User/k1m30xaf.slt/panacea.dat
   */
  var NS_APP_MESSENGER_FOLDER_CACHE_50_DIR = "MFCaD"; 
   ...
   */
  var NS_OS_CURRENT_PROCESS_DIR = "CurProcD"; 
  
  var NS_OS_DESKTOP_DIR = "Desk";
  
  /** 
   * /root
   */
  var NS_OS_HOME_DIR = "Home"; 
  
  /** 
   * /tmp
   */
  var NS_OS_TEMP_DIR = "TmpD"; 
  
  /**
   * /usr/src/mozilla/dist/bin/components
   */
  var NS_XPCOM_COMPONENT_DIR = "ComsD"; 
