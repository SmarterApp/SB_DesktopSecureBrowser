if (typeof(JS_LIB_LOADED)=='boolean')
{
  ...
  var JS_FILEUTILS_FILE              = "fileUtils.js";
  var JS_FILEUTILS_LOADED            = true;
  
  var JS_FILEUTILS_LOCAL_CID         = "@mozilla.org/file/local;1";
  var JS_FILEUTILS_IO_SERVICE_CID    = '@mozilla.org/network/io-service;1';
  var JS_FILEUTILS_CHROME_REG_PROGID = '@mozilla.org/chrome/chrome-registry;1';
  var JS_FILEUTILS_PROCESS_CID       = "@mozilla.org/process/util;1";
  
  var JS_FILEUTILS_nsIFile           = new Components.Constructor
  ...
  var JS_FILEUTILS_FilePath          = JS_FILEUTILS_nsIFile;

  var JS_FILEUTILS_FILESPEC_PROGID   = '@mozilla.org/filespec;1';
  var JS_FILEUTILS_NETWORK_STD_CID   = '@mozilla.org/network/standard-url;1';
  var JS_FILEUTILS_DR_PROGID         = "@mozilla.org/file/directory_service;1";
  var JS_FILEUTILS_I_LOCAL_FILE      = "nsILocalFile";
  var JS_FILEUTILS_INIT_W_PATH       = "initWithPath";
  var JS_FILEUTILS_I_PROPS           = "nsIProperties";
  var JS_FILEUTILS_CHROME_DIR        = "AChrom";
  var JS_FILEUTILS_OK                = true;
