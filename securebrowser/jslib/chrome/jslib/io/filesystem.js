...
{
  var JS_FILESYSTEM_LOADED = true;
  var JS_FILESYSTEM_FILE   = "filesystem.js";

  var JS_FS_LOCAL_CID      = "@mozilla.org/file/local;1";
  var JS_FS_NETWORK_CID    = '@mozilla.org/network/standard-url;1';
  var JS_FS_URL_COMP       = "nsIURL";

  var JS_FS_File_nsIFile   = new Components.Constructor
                                     (JS_FS_LOCAL_CID, 
                                      "nsILocalFile",
                                      "initWithPath");

  var JS_FS_URL            = new Components.Constructor
                                     (JS_FS_NETWORK_CID, 
                                      JS_FS_URL_COMP);
  
  /* DEPRECATED! */
  var JS_FS_File_Path      = JS_FS_File_nsIFile;
  var JS_FS_INIT_W_PATH    = "initWithPath";
  var JS_FS_I_LOCAL_FILE   = "nsILocalFile";
  var JS_FS_CHROME_DIR     = "AChrom";
  var JS_FS_PREF_DIR       = "PrefD";
  var JS_FS_USR_DEFAULT    = "DefProfRt";
  var JS_FS_DIR_I_PROPS    = "nsIProperties";
  var JS_FS_DIR_CID        = "@mozilla.org/file/directory_service;1";

  var JS_FS_Dir            = new Components.Constructor
                                     (JS_FS_DIR_CID, 
                                      JS_FS_DIR_I_PROPS);
