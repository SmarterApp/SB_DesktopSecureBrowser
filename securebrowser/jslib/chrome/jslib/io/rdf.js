var JSLIB_CONTAINER_PROGID = '@mozilla.org/rdf/container;1';
var JSLIB_CONTAINER_UTILS_PROGID = '@mozilla.org/rdf/container-utils;1';
var JSLIB_LOCATOR_PROGID = '@mozilla.org/filelocator;1';
var JSLIB_RDF_PROGID = '@mozilla.org/rdf/rdf-service;1';
var JSLIB_RDF_DS_PROGID = '@mozilla.org/rdf/datasource;1?name=xml-datasource';

var JSLIB_RDF_FLAG_SYNC = 1;        // load RDF source synchronously
var JSLIB_RDF_FLAG_DONT_CREATE = 2; // don't create RDF file (RDFFile only)
