if (typeof(JS_LIB_LOADED) == 'boolean') 
{
  ...
  var JS_FILE_FILE             = "file.js";
  
  var JS_FILE_IOSERVICE_CID    = "@mozilla.org/network/io-service;1";
  var JS_FILE_I_STREAM_CID     = "@mozilla.org/scriptableinputstream;1";
  var JS_FILE_OUTSTREAM_CID    = "@mozilla.org/network/file-output-stream;1";
  var JS_FILE_BINOUTSTREAM_CID = "@mozilla.org/binaryoutputstream;1";
  var JS_FILE_BININSTREAM_CID  = "@mozilla.org/binaryinputstream;1";
  
  var JS_FILE_F_TRANSPORT_SERVICE_CID  = 
    "@mozilla.org/network/file-transport-service;1";
  
  var JS_FILE_I_IOSERVICE              = jslibI.nsIIOService;
  var JS_FILE_I_SCRIPTABLE_IN_STREAM   = "nsIScriptableInputStream";
  var JS_FILE_I_FILE_OUT_STREAM        = jslibI.nsIFileOutputStream;
  var JS_FILE_I_BINARY_OUT_STREAM      = "nsIBinaryOutputStream";
  var JS_FILE_I_BINARY_IN_STREAM       = "nsIBinaryInputStream";
  
  var JS_FILE_READ          = 0x01;  // 1
  var JS_FILE_WRITE         = 0x08;  // 8
  var JS_FILE_APPEND        = 0x10;  // 16
  
  var JS_FILE_READ_MODE     = "r";
  var JS_FILE_WRITE_MODE    = "w";
  var JS_FILE_APPEND_MODE   = "a";
  var JS_FILE_BINARY_MODE   = "b";
  
  var JS_FILE_FILE_TYPE     = 0x00;  // 0
  var JS_FILE_CHUNK         = 1024;  // buffer for readline => set to 1k
  var JS_FILE_DEFAULT_PERMS = 0644;
  
  try {
    var JS_FILE_InputStream  = new Components.Constructor
      (JS_FILE_I_STREAM_CID, JS_FILE_I_SCRIPTABLE_IN_STREAM);
  
    var JS_FILE_IOSERVICE    = jslibGetService(JS_FILE_IOSERVICE_CID,
                                                 JS_FILE_I_IOSERVICE);
  ...
  var JS_FILE_NS_RDONLY               = 0x01;
  var JS_FILE_NS_WRONLY               = 0x02;
  var JS_FILE_NS_RDWR                 = 0x04;
  var JS_FILE_NS_CREATE_FILE          = 0x08;
  var JS_FILE_NS_APPEND               = 0x10;
  var JS_FILE_NS_TRUNCATE             = 0x20;
  var JS_FILE_NS_SYNC                 = 0x40;
  var JS_FILE_NS_EXCL                 = 0x80;
  ...
  ****************************************************************/
  ...
  File.prototype.write = function (aBuffer)
  {
    ...
    var rv  = JS_LIB_OK;
    try {
      if (this.mIsBinary && aBuffer.varructor == Array) 
