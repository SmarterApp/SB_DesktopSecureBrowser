...
#endif
#define kDesktopFolder "securebrowser"
...
int main(int argc, char* argv[], char* envp[])
{
  ...
  // this is causing the app menu when right clicking on Ubuntu ONLY...
  sysrv = system("name=`lsb_release -i 2>/dev/null | grep -i ubuntu`; if [ -z \"$name\" ]; then gsettings set org.gnome.desktop.wm.preferences mouse-button-modifier \"''\" > /dev/null 2>&1; fi");
  ...
  sysrv = system("gsettings set org.gnome.settings-daemon.plugins.media-keys video-out '' > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.settings-daemon.plugins.media-keys magnifier '' > /dev/null 2>&1");

  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings unmaximize \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings show-desktop \"['']\" > /dev/null 2>&1");

  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-down \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-1 \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-2 \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-3 \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-4 \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-5 \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-6 \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-7 \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-8 \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-9 \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-10 \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-11 \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-12 \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-left \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-last \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-up \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-right \"['']\" > /dev/null 2>&1");

  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings switch-panels \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.desktop.wm.keybindings panel-run-dialog \"['']\" > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.settings-daemon.plugins.media-keys logout '' > /dev/null 2>&1");
  sysrv = system("gsettings set org.gnome.settings-daemon.plugins.xrandr active false > /dev/null 2>&1");

  sysrv = system("gsettings reset org.gnome.settings-daemon.plugins.media-keys custom-keybindings > /dev/null 2>&1");

  sysrv = system("dconf write /org/compiz/profiles/unity/plugins/unityshell/launcher-hide-mode 0 > /dev/null 2>&1");
  sysrv = system("dconf write /org/compiz/profiles/unity/plugins/unityshell/edge-responsiveness 0.0 > /dev/null 2>&1");

  sysrv = system("gsettings set com.canonical.Unity.Launcher favorites \"['']\" > /dev/null 2>&1");

  sysrv = system("dconf write /org/compiz/profiles/unity/plugins/core/active-plugins \"['core', 'composite', 'opengl', 'place', 'regex', 'resize', 'session', 'snap', 'vpswitch', 'wall', 'animation', 'commands', 'compiztoolbox', 'copytex', 'fade', 'grid', 'imgpng', 'mousepoll', 'move', 'unitymtgrabhandles', 'workarounds', 'expo', 'ezoom']\" > /dev/null 2>&1");

  // Call startup script to cover any hot fixes
  sysrv = system("./sbstartup.sh");
...
#if defined(XP_UNIX)
#ifndef XP_MACOSX
   sysrv = system("dconf write /org/compiz/profiles/unity/plugins/core/active-plugins \"['core', 'composite', 'opengl', 'place', 'regex', 'resize', 'session', 'snap', 'vpswitch', 'wall', 'animation', 'commands', 'compiztoolbox', 'copytex', 'fade', 'grid', 'imgpng', 'mousepoll', 'move', 'scale', 'unitymtgrabhandles', 'workarounds', 'expo', 'ezoom', 'unityshell']\" > /dev/null 2>&1");
  ...
  sysrv = system("gsettings reset org.gnome.settings-daemon.plugins.media-keys video-out > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.settings-daemon.plugins.media-keys magnifier > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings unmaximize > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings show-desktop > /dev/null 2>&1");

  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-down > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-1 > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-2 > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-3 > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-4 > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-5 > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-6 > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-7 > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-8 > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-9 > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-10 > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-11 > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-12 > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-left > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-last > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-up > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-to-workspace-right > /dev/null 2>&1");

  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings switch-panels > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.desktop.wm.keybindings panel-run-dialog > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.settings-daemon.plugins.media-keys logout > /dev/null 2>&1");
  sysrv = system("gsettings reset org.gnome.settings-daemon.plugins.xrandr active > /dev/null 2>&1");

  sysrv = system("gsettings reset com.canonical.Unity.Launcher favorites > /dev/null 2>&1");

  sysrv = system("./sbshutdown.sh");
